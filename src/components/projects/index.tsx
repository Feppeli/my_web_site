...
const Projects = (props:projectProps) => {
    return <>
    <div className="w-full bg-zinc-800 flex flex-col items-center text-left rounded-lg m-4 md:flex-row lg:w-5/12 lg:items-center justify-between">
            <Image
            className="rounded-lg pt-5 md:p-5"
            src={props.src}
            alt={props.alt}
            width={300}
            height={300}/>
            <div className="lg:p-2 p-4">
                ...
                <div className="bg-none border-blue-600 border-2 rounded-full text-center lg:w-fit p-2 hover:bg-blue-600">
                    <a  className="p-4 text-white font-bold text-2xl transition" href={props.link} target="_blank">See more</a>
                </div>
            </div>
